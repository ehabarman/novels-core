...
import com.itsmite.novels.core.errors.exceptions.InvalidDateException;
import com.itsmite.novels.core.errors.exceptions.InvalidTimeException;
...
public class DateTimeUtil {
    ...
    private final static DateTimeFormatter TIME_FORMATTER = DateTimeFormatter.ofPattern("H:m");
